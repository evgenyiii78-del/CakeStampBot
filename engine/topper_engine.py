...
def build_topper_from_text(
    ...
    """
    logger.info(
        "TOPPER BUILD START v1.3.0 | width=%s font=%s text_h=%s backing_h=%s legs=%s",
    ...
    preview(
        ...
        "topper",
        mask,
        note=f"Topper v1.3.0, TextBase + 2 separate beveled legs, spacing 0.82"
    )
    ...
    meta = {
        ...
        "note": "v1.3.0: unified textbase, separate beveled leg objects, two stronger explicit bridge pads between lines, tighter spacing.",
    }
