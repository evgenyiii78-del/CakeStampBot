...
def build_topper_from_text(
    ...
    """
    logger.info(
        "TOPPER BUILD START v1.1.1 | width=%s font=%s text_h=%s backing_h=%s legs=%s",
    ...
    preview(
        ...
        "topper",
        mask,
        note=f"Topper v1.1.1, TextBase + separate {leg_count} leg(s), spacing 0.82"
    )
    ...
    meta = {
        ...
        "note": "v1.1.1: unified textbase, separate leg objects, two stronger explicit bridge pads between lines, tighter spacing.",
    }
