"""CakeStampBot v2.4.6 release entrypoint."""
...
# v2.4.6: add 130 mm stamp disk size to the current ReplyKeyboard UI.
# Telegram preview/3MF delivery retries remain enabled.
