"""CakeStampBot v2.4.2 UI/runtime patch for thin selectable TTF contour stamps."""
...
def apply_fixes(app):
    ...
    legacy.ensure_stamp_defaults = defaults_v242
    ...
    app.stamp_kb = stamp_kb_v242
    original_panel = app.panel_text

    def panel_text_v242(c):
        defaults_v242(c)
    ...
    app.text_router = text_router_v242
    original_build_model = legacy.build_model

    def build_model_v242(p):
        if p.get("mode") != "stamp":
    ...
    legacy.build_model = build_model_v242
